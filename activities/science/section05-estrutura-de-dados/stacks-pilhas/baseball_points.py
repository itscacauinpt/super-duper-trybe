...
da partida de baseball. Cada item da lista consiste em uma rodada da partida
...
As regras para se calcular os pontos são as seguintes:
     ...
     + (pontos de uma rodada): Os pontos do time para a rodada será o somatório
      dos pontos das duas últimas rodadas válidas;
     D (pontos de uma rodada): Os pontos do time para a rodada será igual ao
      dobro de pontos da ultima rodada válida;
     C (Operação que não é necessáriamente pontos de uma rodada): Representa
      que os pontos da última rodada válida são inválidos e devem ser removidos
"""
