...
localStorage.setItem('nickname', 'Cacau');
...
//let oNome = localStorage.setItem('name', 'Ana');
//console.log(oNome);// não dá

let oNome = localStorage.getItem('name', 'Ana');
console.log(oNome);//agora foi!

localStorage.setItem('birthdate', '16/01/2001');

//let birthday = localStorage.setItem('birthdate', '16/01/2001');
//console.log(birthday)// não dá!

let birthday = localStorage.getItem('birthdate', '16/01/2001');
